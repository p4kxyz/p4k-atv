...
public class AppConfig {
    ...
    private static volatile String runtimeApiServerUrl = getApiServerUrl();
    private static volatile String runtimeApiKey = getApiKey();

    public static final String API_SERVER_URL = runtimeApiServerUrl;
    public static final String API_KEY = runtimeApiKey;
