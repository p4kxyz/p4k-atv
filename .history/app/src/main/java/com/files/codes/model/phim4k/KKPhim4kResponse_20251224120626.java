...
public class KKPhim4kResponse {
    ...
    private KKPhim4kPagination pagination;
    ...
    public KKPhim4kPagination getPagination() { return pagination; }
    public void setPagination(KKPhim4kPagination pagination) { this.pagination = pagination; }
