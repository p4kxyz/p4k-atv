...
public class WatchHistorySyncItem {
    ...
    public static class WatchHistoryItem {
        ...
        public WatchHistoryItem(String videoId, String title, String posterUrl, long position, long duration, String description, long createdAt, boolean isMovieFlag) {
