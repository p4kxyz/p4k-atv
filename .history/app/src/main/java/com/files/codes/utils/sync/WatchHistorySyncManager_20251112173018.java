    ...
    public void addWatchHistoryItemWithMetadata(String videoId, String title, String description, 
        ...
        try {
            ...
            if ("1".equals(isTvSeries)) {
                ...
                curEpisode.put("episodes_id", videoId + "_ep01"); // Tạo ID giả
                curEpisode.put("episodes_name", title); // Dùng title làm episode name
                curEpisode.put("stream_key", ""); 
                curEpisode.put("file_type", "mp4");
                ...
                curSeason.put("seasons_id", videoId + "_s01"); // Tạo season ID giả
                curSeason.put("seasons_name", "Season 01");
                ...
                Log.e(TAG, "✅ Created season/episode data - Season ID: " + curSeason.get("seasons_id") + 
                          ", Episode ID: " + curEpisode.get("episodes_id"));
            }
