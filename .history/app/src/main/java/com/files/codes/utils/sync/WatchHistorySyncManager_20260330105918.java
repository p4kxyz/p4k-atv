...
public class WatchHistorySyncManager {
    ...
    public void deleteWatchHistoryItem(String videoId, final SyncCallback callback) {
        ...
        try {
            ...
            // Primary remove by map key.
            if (localHistory.remove(videoId) != null) {
                removed = true;
            } else {
                // Fallback remove by item.videoId in case key and payload mismatch.
            ...
            // If sync is not configured, local delete is enough.
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    if (response.isSuccessful()) {
                        ...
                        // Fallback: push local state to server so removed item is not restored later.
