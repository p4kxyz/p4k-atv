            ...
            public View onFocusSearch(View focused, int direction) {
                ...
                if (direction == View.FOCUS_LEFT) {
                    ...
                    if (focusedId == R.id.hero_thumbnails_grid || isViewInsideHeroThumbnails(focused)) {
                        ...
                        // Fix for Android 7.1: Ensure headers are visible before focusing
                        if (headersFragment.getView() != null && headersFragment.getView().getParent() instanceof View) {
                            ((View) headersFragment.getView().getParent()).setVisibility(View.VISIBLE);
                        }
