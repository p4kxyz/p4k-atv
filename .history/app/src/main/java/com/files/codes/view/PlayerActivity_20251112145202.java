   ...
   /* @SuppressLint("StaticFieldLeak")
    ...
    private void setupEpisodeNavigationButtons() {
        ...
        if (model.getAllSeasons() == null) {
            Log.w("PlayerActivity", "AllSeasons is null, hiding episode navigation buttons");
            previousEpisodeButton.setVisibility(View.GONE);
            nextEpisodeButton.setVisibility(View.GONE);
            return;
        }
        
        if (model.getCurrentSeasonIndex() < 0) {
            Log.w("PlayerActivity", "CurrentSeasonIndex < 0 (" + model.getCurrentSeasonIndex() + 
                    "), hiding episode navigation buttons");
            previousEpisodeButton.setVisibility(View.GONE);
            nextEpisodeButton.setVisibility(View.GONE);
            return;
        }
