                ...
                if (completeMovieData != null) {
                    ...
                    watchHistorySyncManager.saveFullWatchHistory(
                        ...
                        completeMovieData.getThumbnailUrl() != null ? completeMovieData.getThumbnailUrl() : 
                            (completeMovieData.getPosterUrl() != null ? completeMovieData.getPosterUrl() : ""),
                        model.getVideoUrl() != null ? model.getVideoUrl() : "", // Video URL from PlaybackModel
                        currentPosition,
                        duration,
                        ...
                        model.getVideoQuality() != null ? model.getVideoQuality() : "", // Video quality from PlaybackModel
                        model.getIsTvSeries() != null ? model.getIsTvSeries() : "0", // TV series flag from PlaybackModel
                        completeMovieData // Pass complete MovieSingleDetails for full metadata
                    );
