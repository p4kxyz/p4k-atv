                ...
                if (completeMovieData != null) {
                    ...
                    if (isTvSeries.equals("1")) {
                        ...
                        if (model.getCurrentSeason() != null) {
                            curSeason = convertSeasonToMap(model.getCurrentSeason());
                        }
                        
                        // Get current episode data from model if available  
                        if (model.getCurrentEpisode() != null) {
                            curEpisode = convertEpisodeToMap(model.getCurrentEpisode());
                        }
