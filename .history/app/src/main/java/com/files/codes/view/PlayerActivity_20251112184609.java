                ...
                if (completeMovieData != null) {
                    ...
                    if (isTvSeries.equals("1")) {
                        ...
                        if (model.getAllSeasons() != null && model.getCurrentSeasonIndex() >= 0 && 
                            ...
                            if (currentSeason.getEpisodeList() != null && model.getCurrentEpisodeIndex() >= 0 && 
                                model.getCurrentEpisodeIndex() < currentSeason.getEpisodeList().size()) {
                                Episode currentEpisode = currentSeason.getEpisodeList().get(model.getCurrentEpisodeIndex());
                    ...
                    // Fallback to basic watch history saving when complete data is not available
                    String isTvSeries = model.getIsTvSeries() != null ? model.getIsTvSeries() : "0";
