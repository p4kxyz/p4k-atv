        ...
        if (validDuration && validPosition && watchHistorySyncManager != null) {
            try {
                ...
                if (completeMovieData != null) {
                    ...
                    // Prepare data for saveFullWatchHistory method
                    String videoId = completeMovieData.getVideosId();
                    String title = completeMovieData.getTitle() != null ? completeMovieData.getTitle() : "Unknown Title";
                    String description = completeMovieData.getDescription() != null ? completeMovieData.getDescription() : "";
                    String slug = completeMovieData.getSlug() != null ? completeMovieData.getSlug() : "";
                    String releaseDate = completeMovieData.getRelease() != null ? completeMovieData.getRelease() : "";
                    String runtime = completeMovieData.getRuntime() != null ? completeMovieData.getRuntime() : "";
                    ...
                    String enableDownload = completeMovieData.getEnableDownload() != null ? completeMovieData.getEnableDownload() : "0";
                    String thumbnailUrl = completeMovieData.getThumbnailUrl() != null ? completeMovieData.getThumbnailUrl() : 
                        (completeMovieData.getPosterUrl() != null ? completeMovieData.getPosterUrl() : "");
                    String posterUrl = completeMovieData.getPosterUrl() != null ? completeMovieData.getPosterUrl() : "";
                    String imdbRating = completeMovieData.getImdbRating() != null ? completeMovieData.getImdbRating() : "";
                    ...
                    // Fallback: Try to fetch complete data immediately if we have movieId
                    if (model.getMovieId() != null && !model.getMovieId().equals("null") && !model.getMovieId().isEmpty()) {
                        Log.w(TAG, "⚠️ CompleteMovieData is null, but movieId available. Trying to fetch now: " + model.getMovieId());
                        // Try to fetch immediately (synchronous approach for critical data)
                        fetchCompleteMovieDataForWatchHistory(model.getMovieId(), model.getVideoType() != null ? model.getVideoType() : "movie");
                    }
                    
                    // Use basic watch history saving when complete data is not available
                    String isTvSeries = model.getIsTvSeries() != null ? model.getIsTvSeries() : "0";
                    ...
                    Log.d(TAG, "💾 Saving BASIC watch history - ID: " + saveId + " (originalMovieId: " + model.getMovieId() + ")" +
                              ", Title: " + title +
                              ", Type: " + (model.getVideoType() != null ? model.getVideoType() : "movie") + 
                              ", isTvSeries: " + isTvSeries + 
                              ", Position: " + currentPosition + "ms");
                    
                    // Debug: Log all model data being saved
                    Log.d(TAG, "🔍 BASIC watch history data debug:");
                    Log.d(TAG, "  - saveId: " + saveId);
                    Log.d(TAG, "  - title: " + title);
                    Log.d(TAG, "  - description: " + (model.getDescription() != null ? model.getDescription() : "null"));
                    Log.d(TAG, "  - cardImageUrl: " + (model.getCardImageUrl() != null ? model.getCardImageUrl() : "null"));
                    Log.d(TAG, "  - videoUrl: " + (model.getVideoUrl() != null ? model.getVideoUrl() : "null"));
                    Log.d(TAG, "  - videoType: " + (model.getVideoType() != null ? model.getVideoType() : "null"));
                    Log.d(TAG, "  - releaseDate: " + (model.getReleaseDate() != null ? model.getReleaseDate() : "null"));
                    Log.d(TAG, "  - imdbRating: " + (model.getImdbRating() != null ? model.getImdbRating() : "null"));
                    Log.d(TAG, "  - runtime: " + (model.getRuntime() != null ? model.getRuntime() : "null"));
                    Log.d(TAG, "  - videoQuality: " + (model.getVideoQuality() != null ? model.getVideoQuality() : "null"));
                    Log.d(TAG, "  - isTvSeries: " + isTvSeries);
                    ...
                    watchHistorySyncManager.addWatchHistoryItemWithMetadata(
                        ...
                        model.getCardImageUrl() != null ? model.getCardImageUrl() : "",
                        model.getVideoUrl() != null ? model.getVideoUrl() : "",
                        currentPosition, 
                        duration, 
                        ...
                        model.getRuntime() != null ? model.getRuntime() : "",
                        model.getVideoQuality() != null ? model.getVideoQuality() : "",
                        isTvSeries
                    );
                }
    ...
    */
    ...
    private void fetchCompleteMovieDataForWatchHistory(String movieId, String movieType) {
        ...
        call.enqueue(new Callback<MovieSingleDetails>() {
            ...
            public void onResponse(Call<MovieSingleDetails> call, Response<MovieSingleDetails> response) {
                if (response.isSuccessful() && response.body() != null) {
                    completeMovieData = response.body();
                    Log.d(TAG, "✅ Successfully fetched complete movie data: " + completeMovieData.getTitle() + 
                              " - Genres: " + (completeMovieData.getGenre() != null ? completeMovieData.getGenre().size() : 0) +
                              ", Cast: " + (completeMovieData.getCastAndCrew() != null ? completeMovieData.getCastAndCrew().size() : 0) +
                              ", Directors: " + (completeMovieData.getDirector() != null ? completeMovieData.getDirector().size() : 0));
