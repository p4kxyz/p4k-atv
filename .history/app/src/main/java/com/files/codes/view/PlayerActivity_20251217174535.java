...
public class PlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "🔍 onCreate - External Player Check: " + useExternalPlayer);

        if (useExternalPlayer) {
            Log.d(TAG, "🚀 onCreate - Launching External Player sequence...");
...
//                }
    ...
    private void launchExternalPlayer() {
        try {
            ...
            Log.d(TAG, "🎮 Selected Player: " + selectedPlayer);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (position > 0) {
                ...
                Log.w(TAG, "⚠️ Position is 0 or invalid, not saving history.");
            }
        } else {
            Log.w(TAG, "⚠️ onActivityResult - Result not OK or Data null. ResultCode: " + resultCode);
        }
