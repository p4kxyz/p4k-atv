            ...
            if (subtitleView instanceof StrokeTextView) {
                ...
                if (edgeStyleIndex == 0) { // Outline
                    ...
                    switch (outlineThickness) {
                        case 0: strokeWidth = 2.0f; break; // Thin
                        case 1: strokeWidth = 4.0f; break; // Normal
                        case 2: strokeWidth = 7.0f; break; // Thick
                        case 3: strokeWidth = 10.0f; break; // Extra Thick
                    }
                    strokeView.setStroke(strokeWidth, outlineColor);
