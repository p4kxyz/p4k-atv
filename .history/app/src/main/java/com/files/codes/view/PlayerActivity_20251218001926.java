...
//                }
    ...
    */
    ...
    private void openUnifiedSettingsDialog() {
        ...
        // Use direct integer value for thickness (pt)
        int currentOutlineThickness = prefs.getInt("outline_thickness", 4); // Default to 4pt
        if (currentOutlineThickness < 1) currentOutlineThickness = 1;
        if (currentOutlineThickness > 20) currentOutlineThickness = 20;
        
        outlineThicknessTV.setText(currentOutlineThickness + " pt");
