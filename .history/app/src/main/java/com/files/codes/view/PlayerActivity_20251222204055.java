...
public class PlayerActivity extends Activity {
    ...
    protected void onStart() {
        ...
        if (movieTitleTV != null) {
            ...
            // Check if we have a specific TV Series title from the episode data
                 ...
                 try {
                    if (model.getAllSeasons() != null && 
                        ...
                        if (currentSeason.getEpisodes() != null && 
                            ...
                            String seriesTitle = currentSeason.getEpisodes().get(model.getCurrentEpisodeIndex()).getTvSeriesTitle();
                            if (seriesTitle != null && !seriesTitle.isEmpty()) {
                                titleText = seriesTitle;
                            }
                        }
                    }
                } catch (Exception e) {
