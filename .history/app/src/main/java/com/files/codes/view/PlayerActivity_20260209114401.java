            ...
            runOnUiThread(() -> {
                ...
                if (finalResponse != null && finalResponse.getUrl() != null && !finalResponse.getUrl().isEmpty()) {
                    if (finalResponse.isPlayable()) {
                        ...
                        animeProxyHeaders = finalResponse.getProxyHeaders();
                        ...
                        Log.d(TAG, "Anime stream resolved: " + url + " (type: " + finalResponse.getType() + ")");
                        ...
                        Log.w(TAG, "Anime stream type EMBED not supported: " + finalResponse.getUrl());
                        new ToastMsg(PlayerActivity.this).toastIconError("Nguồn phát này không hỗ trợ (EMBED)");
                        finish();
                    }
                } else {
                    Log.e(TAG, "Failed to resolve anime stream URL after retries");
