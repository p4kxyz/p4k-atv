    ...
    public void initVideoPlayer(String url, String type) {
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onPlayerError(com.google.android.exoplayer2.PlaybackException error) {
                ...
                } else if (error.getCause() instanceof com.google.android.exoplayer2.upstream.HttpDataSource.InvalidResponseCodeException) {
                    ...
                    if (responseCode == 416) {
                        ...
                        if (!has416Retried) {
                            ...
                            if (player != null && url != null && !url.isEmpty()) {
                                ...
                                com.google.android.exoplayer2.source.MediaSource freshSource;
