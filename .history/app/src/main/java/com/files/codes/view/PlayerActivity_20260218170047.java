...
//                }
    ...
    public void initVideoPlayer(String url, String type) {
        ...
        RenderersFactory renderersFactory = new DefaultRenderersFactory(this) {
             ...
             */
            @Override
            protected androidx.media3.common.audio.AudioSink buildAudioSink(Context context, boolean enableFloatOutput, boolean enableAudioTrackPlaybackParams, boolean enableOffload) {
                if (audioMode == 2) { 
                    Log.d("PlayerActivity", "🔊 Passthrough Mode: Forcing AudioSink capabilities");
                    return new androidx.media3.common.audio.DefaultAudioSink.Builder()
                        .setAudioCapabilities(new androidx.media3.common.audio.AudioCapabilities(
                            new int[] {
            ...
            @Override
            public void buildAudioRenderers(Context context, int extensionRendererMode, androidx.media3.exoplayer.mediacodec.MediaCodecSelector mediaCodecSelector, boolean enableDecoderFallback, androidx.media3.common.audio.AudioSink audioSink, Handler eventHandler, androidx.media3.common.audio.AudioRendererEventListener eventListener, java.util.ArrayList<androidx.media3.exoplayer.Renderer> out) {
                    ...
                    if (debugMappedTrackInfo != null) {
                        for (int i = 0; i < debugMappedTrackInfo.getRendererCount(); i++) {
                            ...
                            if (rendererType == C.TRACK_TYPE_AUDIO) {
                                androidx.media3.common.TrackSelection selection = player.getCurrentTrackSelections().get(i);
                                if (selection != null) {
