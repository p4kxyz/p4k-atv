...
//                }
    ...
    private androidx.media3.exoplayer.source.MediaSource rtmpMediaSource(Uri uri) {
        ...
        // Use DefaultHttpDataSource for RTMP - RtmpDataSourceFactory is incompatible with Media3 at runtime
        // For proper RTMP support, consider upgrading to a Media3-compatible RTMP library
