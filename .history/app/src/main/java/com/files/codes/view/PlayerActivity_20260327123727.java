...
public class PlayerActivity extends Activity {
    ...
    private long lastTimeBarSeekAtMs = 0L;
    private static final long TIMEBAR_VERTICAL_NAV_LOCK_MS = 350L;
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_UP:
                if (!exoPlayerView.isControllerVisible()) {
                    ...
                    View timeBar = exoPlayerView.findViewById(R.id.exo_progress);
                    if (timeBar != null && timeBar.hasFocus() && isTimeBarVerticalNavLocked()) {
                        return true;
                    }
                }
                break;
...
//                }
    ...
    private void markTimeBarSeek() {
        lastTimeBarSeekAtMs = SystemClock.elapsedRealtime();
    }

    private boolean isTimeBarVerticalNavLocked() {
        return SystemClock.elapsedRealtime() - lastTimeBarSeekAtMs < TIMEBAR_VERTICAL_NAV_LOCK_MS;
    }
