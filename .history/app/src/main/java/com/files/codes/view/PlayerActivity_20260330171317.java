...
//                }
    ...
    private boolean recoverPlaybackFromStartForHttp416() {
        ...
        try {
            ...
            Toast.makeText(this, "Server không hỗ trợ tua tại vị trí này, đang phát lại từ đầu", Toast.LENGTH_SHORT).show();
            Log.d("PlayerActivity", "✅ Recovered from HTTP 416 by restarting from 0");
            return true;
        } catch (Exception e) {
