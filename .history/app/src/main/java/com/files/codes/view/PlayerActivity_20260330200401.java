                ...
                if (error.getCause() != null) {
                    ...
                    if (causeMessage != null && (
                        ...
                        if (errorMessage != null) {
                            ...
                            } else if (errorMessage.contains("avc")) {
                        ...
                        if (causeMessage != null) {
                            videoDetails.append("Lỗi: ").append(causeMessage.substring(0, Math.min(80, causeMessage.length())));
                        }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    errorDetails.append("Codec video không hỗ trợ.\n");
                    errorDetails.append("Thử video có độ phân giải thấp hơn.\n");
