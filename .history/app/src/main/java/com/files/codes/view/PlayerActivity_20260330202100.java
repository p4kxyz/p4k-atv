...
public class PlayerActivity extends Activity {
    ...
    private static final long SEEK_ERROR_GRACE_MS = 2200L;
...
//                }
    ...
    public void initVideoPlayer(String url, String type) {
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onPlayerError(com.google.android.exoplayer2.PlaybackException error) {
                ...
                if (isLikelySeekTransientError(error, nowMs)) {
                    Log.w("PlayerActivity", "⏭️ Ignoring transient decoder error during seek window");
                    hasPlayerError = false;
                    lastErrorTime = 0;
                    return;
                }
    ...
    */
    ...
    private void showAudioCodecErrorDialog() {
        ...
        errorDetails.append("❌ Audio Playback Error\n\n");
        errorDetails.append("Device: ").append(android.os.Build.DEVICE).append("\n");
        errorDetails.append("SDK: ").append(android.os.Build.VERSION.SDK_INT).append("\n");
        errorDetails.append("ABIs: ").append(java.util.Arrays.toString(android.os.Build.SUPPORTED_ABIS)).append("\n\n");
        
        errorDetails.append("Lỗi: ").append(lastAudioCodecErrorMessage).append("\n");
        if (!lastAudioCodecErrorDetails.isEmpty()) {
            errorDetails.append(lastAudioCodecErrorDetails).append("\n");
        }
        
        errorDetails.append("\n📋 Cách khắc phục:\n");
        errorDetails.append("1. Thử chuyển chế độ giải mã âm thanh\n");
        errorDetails.append("2. Chọn track âm thanh khác (AAC/MP3)\n");
        errorDetails.append("3. Video sẽ phát không có tiếng\n\n");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (!lastVideoCodecDetails.isEmpty()) {
                        errorDetails.append("📋 Chi tiết:\n");
                        errorDetails.append(lastVideoCodecDetails).append("\n\n");
                    }
                    
                    errorDetails.append("Lỗi: ").append(lastVideoCodecError).append("\n\n");
                    
                    errorDetails.append("⚠️ Lưu ý:\n");
                    errorDetails.append("• Codec video không được hỗ trợ trên thiết bị này\n");
                    errorDetails.append("• Thử video có độ phân giải thấp hơn (HD/SD)\n");
                    errorDetails.append("• Thử codec khác: H.264, VP9, AV1\n");
                    errorDetails.append("• Hoặc chọn video khác\n");
                    ...
                    Log.e("PlayerActivity", "Error showing video codec error dialog", e);
                    showErrorDialog("Lỗi video", "Codec video không được hỗ trợ trên thiết bị này.");
                }
            }
        });
    }
