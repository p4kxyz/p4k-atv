    ...
    private void openSubtitleDialog() {
        ...
        subsourceFetchButton.setOnClickListener(v -> {
            String apiKey = subsourceApiKeyInput.getText() != null
                ? subsourceApiKeyInput.getText().toString().trim()
                : "";
            ...
            subsourceFetchButton.setEnabled(false);
            fetchSubsourceSubtitles(apiKey, combinedSubtitles, adapter, subsourceFetchButton);
        });
