    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        card.setOnFocusChangeListener((v, hasFocus) -> {
            ...
            if (card.getParent() instanceof android.view.View) {
                ((android.view.View) card.getParent()).setAlpha(1.0f);
            }
        });
        ...
        card.addOnAttachStateChangeListener(new android.view.View.OnAttachStateChangeListener() {
            ...
            private void clearDimmingRecursively(android.view.View v) {
                ...
                if (v.getParent() instanceof android.view.View) {
                    android.view.View viewParent = (android.view.View) v.getParent();
                    viewParent.setAlpha(1.0f);
                    viewParent.setBackgroundColor(android.graphics.Color.TRANSPARENT);
                    viewParent.setBackground(null);
                    
                    if (viewParent.getParent() instanceof android.view.View) {
                        android.view.View grandparent = (android.view.View) viewParent.getParent();
