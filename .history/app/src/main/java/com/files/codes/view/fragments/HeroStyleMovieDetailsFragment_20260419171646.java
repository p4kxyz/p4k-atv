...
public class HeroStyleMovieDetailsFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        descriptionToggleButton = view.findViewById(R.id.description_toggle_btn);
    ...
    private void setMovieDescription() {
        bindDescription(movieDetails != null ? movieDetails.getDescription() : null);
    }
    ...
    private void bindDescription(String description) {
        fullDescription = description != null ? description.trim() : "";
        ...
        movieDescription.setText(fullDescription);
        ...
        movieDescription.post(() -> {
            boolean needsToggle = movieDescription.getLineCount() > 4 || fullDescription.length() > 150;
    ...
    private void updateDescriptionState() {
        ...
        movieDescription.setMaxLines(4);
