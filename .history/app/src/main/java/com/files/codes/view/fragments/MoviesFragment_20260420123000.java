...
//        fm.beginTransaction().add(R.id.custom_frame_layout, mSpinnerFragment).commit();
        ...
        String yearFrom = filterYearFrom != null ? String.valueOf(filterYearFrom) : null;
        String yearTo = filterYearTo != null ? String.valueOf(filterYearTo) : null;
        ...
        Log.e("API_TRACE", "Movies fetchMovieData -> isFilterActive=" + isFilterActive
    ...
    public void applyYearFilter(Integer yearFrom, Integer yearTo) {
        Log.d(TAG, "📅 Applying year filter: " + yearFrom + " - " + yearTo);
        this.filterYearFrom = yearFrom;
        this.filterYearTo = yearTo;
        this.isFilterActive = (filterGenreId != null || filterCountryId != null || yearFrom != null);
        refreshMovies();
    }
