...
public class SearchFragment extends SearchSupportFragment implements SearchSupportFragment.SearchResultProvider, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ✅ Setup navigation to filter button (left side)
        try {
            ...
            if (searchBar != null && getActivity() != null) {
                View filterButton = getActivity().findViewById(R.id.btn_advanced_filters);
                if (filterButton != null) {
                    if (searchEditText != null) {
                        searchEditText.setNextFocusLeftId(R.id.btn_advanced_filters);
                        // Log.d(TAG, "✅ Search edit text navigation LEFT to filter button configured");
                    }
                    searchBar.setNextFocusLeftId(R.id.btn_advanced_filters);
                    // Log.d(TAG, "✅ Search bar navigation LEFT to filter button configured");
                }
            }
        } catch (Exception e) {
