...
public class HomeNewFragment extends BrowseSupportFragment {
            ...
            public Presenter getPresenter(Object item) {
                return new RowHeaderPresenter() {
                    ...
                    protected void onSelectLevelChanged(ViewHolder holder) {
                        // Override to prevent default selection effects
                        // Do nothing - no default selection animation
                    }
    ...
    private void setupUi() {
        ...
        // Disable all browse fragment animations and effects
        setEntranceTransitionType(null);
