...
public class IconHeaderItemPresenter extends RowHeaderPresenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object o) {
        ...
        android.util.Log.d(TAG, "Binding header item: " + iconHeaderItem.getName() + ", Icon ID: " + iconHeaderItem.getIconResId());
        ...
        if (iconResId != IconHeaderItem.ICON_NONE) { // Show icon only when it is set.
            ...
            android.util.Log.d(TAG, "Icon set for: " + iconHeaderItem.getName());
        } else {
            iconView.setVisibility(View.GONE);
            android.util.Log.d(TAG, "No icon for: " + iconHeaderItem.getName());
        }
