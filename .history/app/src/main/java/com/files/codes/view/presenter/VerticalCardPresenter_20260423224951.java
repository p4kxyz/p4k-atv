...
public class VerticalCardPresenter extends Presenter {
    ...
    class CustomViewHolder extends Presenter.ViewHolder {
        ...
        private String determineSourceType(VideoContent vc) {
            // Check videoId / videoUrl patterns first for free sources
            String videoId = vc.getId();
            if (videoId != null && !videoId.isEmpty()) {
                String idLower = videoId.toLowerCase();
                if (idLower.contains("kkphim") || idLower.contains("kkphim4k")) {
                    return "Free 2";
                } else if (idLower.contains("phim4k")) {
                    return "Free 1";
                }
            }
            ...
            if (videoUrl != null && !videoUrl.isEmpty()) {
                ...
                if (urlLower.contains("kkphim") || urlLower.contains("kkphim4k")) {
                    return "Free 2";
                } else if (urlLower.contains("phim4k")) {
                    return "Free 1";
                }
            }
