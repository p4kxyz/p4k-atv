...
std::string buildAdsWorkerSecret() {
    return decodeMaskedString(ADS_SECRET_XOR, sizeof(ADS_SECRET_XOR), kXorKey);
}
...
jstring getAdsWorkerSecretImpl(JNIEnv *env, jclass clazz) {
    (void) clazz;
    std::string secret = buildAdsWorkerSecret();
    jstring result = env->NewStringUTF(secret.c_str());
...
jstring nativeGetDynamicSecret2Impl(JNIEnv *env, jclass clazz) {
    (void) clazz;
    std::string secret = buildVideoSecret();
    jstring result = env->NewStringUTF(secret.c_str());
    secureClearString(secret);
...
bool registerVideoTokenGenerator(JNIEnv *env) {
    ...
    const JNINativeMethod methods[] = {
            ...
            {
                const_cast<char *>("nativeGetDynamicSecret2"),
                const_cast<char *>("()Ljava/lang/String;"),
                reinterpret_cast<void *>(nativeGetDynamicSecret2Impl)
            }
    };
...
bool registerAppConfig(JNIEnv *env) {
    ...
    const JNINativeMethod methods[] = {
        ...
        {
            const_cast<char *>("getAdsWorkerSecret"),
            const_cast<char *>("()Ljava/lang/String;"),
            reinterpret_cast<void *>(getAdsWorkerSecretImpl)
        }
    };
