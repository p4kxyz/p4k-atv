...
def replace_method(source_code, method_declaration, new_method_code):
    ...
    old_code = source_code[start_idx:end_idx]
...
'''
content = replace_method(content, "private void showErrorDialog(String title, String message, boolean finishOnClose)", r5_1)
...
r6_2 = r'''    private void showAudioTrackSwitchedNotification() {
        buildCustomAlertDialog(
            ...
            "Đã tự tự động chuyển từ EAC3 sang định dạng âm thanh tương thích khác. Video sẽ phát với âm thanh mới.",
...
with open('app/src/main/java/com/files/codes/view/PlayerActivity.java', 'w', encoding='utf-8') as f:
    f.write(content)
print("Methods successfully replaced!")
