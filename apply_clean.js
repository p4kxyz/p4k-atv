...
// 1. Replace the click listener completely
const clickRegex = /\/\/ Click [^\n]*\n\s*private OnItemViewClickedListener getDefaultItemViewClickedListener\(\) \{[\s\S]*?private OnItemViewSelectedListener/m;

const newClickAndHelpers = `private OnItemViewClickedListener getDefaultItemViewClickedListener() {
...
// 2. Append the buildCustomListDialog at the end of the file right before the last closing brace
const customDialogCode = `
    ...
    private android.app.Dialog buildCustomListDialog(
        ...
        // Optional Cancel Button for uniform aesthetics
...
content = content.replace(/}\s*$/m, customDialogCode);
