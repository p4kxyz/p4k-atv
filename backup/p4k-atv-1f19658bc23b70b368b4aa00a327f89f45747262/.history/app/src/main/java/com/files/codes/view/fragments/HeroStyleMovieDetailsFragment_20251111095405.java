...
public class HeroStyleMovieDetailsFragment extends Fragment {
    ...
    private void playVideoDirectly(Video video) {
        ...
        androidx.core.app.ActivityOptionsCompat bundle = androidx.core.app.ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity());
        ...
        playbackModel.setCategory(videoType != null ? videoType : "movie");
        playbackModel.setCardImageUrl(movieDetails.getPosterUrl());
        playbackModel.setVideoType(videoType != null ? videoType : "movie");
        playbackModel.setVideoUrl(video.getFileUrl());

        Intent intent = new Intent(getActivity(), PlayerActivity.class);
        intent.putExtra("model", playbackModel);
        ...
        if (videos.size() != 0) {
            ...
            serverAdapter.setOnItemClickListener(new com.files.codes.view.adapter.ServerAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, com.files.codes.model.Video obj, int position, com.files.codes.view.adapter.ServerAdapter.OriginalViewHolder holder) {
                    ...
                    com.files.codes.model.PlaybackModel video = new com.files.codes.model.PlaybackModel();
                    
                    // Set movieId for watch history tracking
                    video.setMovieId(videoId);
                    video.setTitle(movieDetails.getTitle());
                    video.setDescription(movieDetails.getDescription());
                    video.setCategory(videoType != null ? videoType : "movie");
                    video.setCardImageUrl(movieDetails.getPosterUrl());
                    video.setVideoType(videoType != null ? videoType : "movie");
