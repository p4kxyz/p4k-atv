...
public class HeroStyleMovieDetailsFragment extends Fragment {
    ...
    private void setHeroInfoTags() {
        ...
        // Set TMDB rating
        if (movieDetails.getTmdbRating() != null && !movieDetails.getTmdbRating().equals("0") && !movieDetails.getTmdbRating().isEmpty()) {
            heroImdbRating.setText(movieDetails.getTmdbRating());
