...
public class OTADownloadManager {
    ...
    public void downloadUpdate(String downloadUrl, String version) {
        try {
            ...
            Log.d(TAG, "APK filename: " + fileName);
            ...
            Log.d(TAG, "✅ Started downloading update: " + version);
    ...
    private void registerDownloadReceiver() {
        ...
        if (downloadReceiver != null) {
            try {
                ...
                Log.d(TAG, "📡 Old receiver unregistered");
            } catch (Exception e) {
        ...
        downloadReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (id == downloadId) {
                    Log.d(TAG, "📡 ✅ Download ID matches! Handling completion...");
        ...
        Log.d(TAG, "📡 ✅ Download receiver registered successfully!");
    }
    
    private void handleDownloadComplete() {
        Log.d(TAG, "📥 Download completed callback received");
    ...
    public void installApk(String apkPath) {
        try {
            ...
            if (fileSize < 1000000) { // Less than 1MB is suspicious
                Log.e(TAG, "❌ APK file too small, might be corrupted: " + fileSize + " bytes");
                if (listener != null) {
                    listener.onDownloadFailed("APK file appears to be corrupted (too small)");
                }
                return;
            }
            ...
            // Check if file is readable
            if (!apkFile.canRead()) {
                Log.e(TAG, "❌ Cannot read APK file");
                if (listener != null) {
                    listener.onDownloadFailed("Cannot read APK file");
                }
                return;
            }
            
            Log.d(TAG, "✅ APK validation passed, proceeding with installation");
            ...
            Log.d(TAG, "📱 ===== APK INSTALLATION COMPLETED =====");

            // Kill app process to avoid conflicts during installation as requested
