...
public class TvRecommendationManager {
    ...
    public void addToRecommended(List<VideoContent> contentList) {
        try {
            ...
            // Clear existing programs for this channel before adding new ones
            try {
                ...
                Log.e(TAG, ">>> Cleared " + deleted + " old programs from channel " + channelId);
            } catch (Exception cleanupEx) {
                Log.w(TAG, "Could not clear old programs: " + cleanupEx.getMessage());
            }
            ...
            Log.e(TAG, ">>> addToRecommended complete: " + addedCount + "/" + contentList.size() + " programs added to channel " + channelId);
