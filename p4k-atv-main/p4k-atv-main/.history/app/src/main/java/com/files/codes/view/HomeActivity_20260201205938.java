    ...
    private void setupCustomFrameLayout() {
        ...
        customFrameLayout.setOnFocusSearchListener(new CustomFrameLayout.OnFocusSearchListener() {
            ...
            public View onFocusSearch(View focused, int direction) {
                boolean isRtl = (ViewCompat.getLayoutDirection(customFrameLayout) == ViewCompat.LAYOUT_DIRECTION_RTL);
                int forwardDirection = isRtl ? View.FOCUS_LEFT : View.FOCUS_RIGHT;
                int backwardDirection = isRtl ? View.FOCUS_RIGHT : View.FOCUS_LEFT;
                ...
                } else if (direction == forwardDirection) {
                    // Close Menu / Go to Content
                    if (focused == orbView) {
