...
public class PlayerActivity extends Activity {
    ...
    private static final long SEEK_COALESCE_WINDOW_MS = 120L;
...
//                }
    ...
    private void enqueueSeekDelta(long deltaMs) {
        ...
        // Coalesce repeated key-hold events into one seek operation.
        safeSeekHandler.removeCallbacks(applyPendingSeekRunnable);
        safeSeekHandler.removeCallbacks(clearSeekingFlagRunnable);
        safeSeekHandler.postDelayed(applyPendingSeekRunnable, SEEK_COALESCE_WINDOW_MS);
    }
