...
public class ActorMoviesFragment extends GridFragment {
    ...
    private void loadActorMovies() {
        ...
        // Use search_by_actor endpoint - it searches both movies and series automatically
        Call<SearchModel> call = apiService.searchByActor(AppConfig.API_KEY, actorName, 1);
