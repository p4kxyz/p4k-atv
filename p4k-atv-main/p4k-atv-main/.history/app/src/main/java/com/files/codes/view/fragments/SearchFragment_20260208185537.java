...
public class SearchFragment extends SearchSupportFragment implements SearchSupportFragment.SearchResultProvider, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Style search bar with white focus border + click-to-type behavior
    ...
    /**
     * Style the Leanback search bar:
     * - White border when focused (via drawable selector)
     * - Search bar acts as focusable container
     * - Press ENTER/DPAD_CENTER to focus into EditText for typing
     */
    private void setupSearchBarFocusStyle(View rootView) {
        try {
            final View searchBar = findViewByName(rootView, "lb_search_bar");
            final View searchEditText = findViewByName(rootView, "lb_search_text_editor");
            
            if (searchBar != null) {
                // Apply focus border drawable to search bar
                ...
                if (searchEditText instanceof EditText) {
                    final EditText editText = (EditText) searchEditText;
                    
                    // Initially prevent EditText from stealing focus
                    editText.setFocusable(false);
                    editText.setFocusableInTouchMode(false);
                    
                    // When search bar gets ENTER/CENTER, activate EditText
                    ...
                    // When EditText loses focus, make search bar focusable again
