...
public class HomeNewActivity extends FragmentActivity {
    ...
    private void setupSettingsOrb() {
        ...
        if (settingsOrb != null) {
            ...
            settingsOrb.setOrbIcon(ContextCompat.getDrawable(this, R.drawable.ic_settings_white));
            settingsOrb.setOrbColor(getResources().getColor(R.color.colorPrimary));
    ...
    private void setupSearchOrb() {
        ...
        if (searchOrb != null) {
             searchOrb.setOrbColor(getResources().getColor(R.color.colorPrimary));
            ...
            customFrameLayout.setOnFocusSearchListener(new com.files.codes.view.CustomFrameLayout.OnFocusSearchListener() {
                ...
                public View onFocusSearch(View focused, int direction) {
                    ...
                    if ((focused == searchOrb || focused == settingsOrb) && direction == View.FOCUS_DOWN) {
                         ...
                         // Find the fragment view to transfer focus to
