...
public class HeroThumbnailPresenter extends Presenter {
     ...
     * Size: 576x324px for xxhdpi (192dp * 3 = 576px, 108dp * 3 = 324px)
     */
    private String getOptimizedThumbnailUrl(String imageUrl) {
        try {
            ...
            // Thumbnail dimensions for xxhdpi (3x): 192dp → 576px, 108dp → 324px
            int thumbnailWidth = 576;
            int thumbnailHeight = 324;
