...
function testAPI($url, $api_key = null) {
    $ch = curl_init();
...
// Test các endpoints đúng với REST API - dựa trên V130.php controller
$endpoints = [
    // Test basic endpoints
    "/rest-api/v130/test?api_key={$api_key}",
    "/api?api_key={$api_key}",
    
    // Movies endpoints
    "/rest-api/v130/movies?api_key={$api_key}&page=1",
    "/rest-api/v130/latest_movies?api_key={$api_key}&limit=2",
    
    // Search endpoints - đây là endpoint chính để search
    "/rest-api/v130/search?api_key={$api_key}&q=strange",
    "/rest-api/v130/search?api_key={$api_key}&q=duong%20trieu",
    "/rest-api/v130/search?api_key={$api_key}&q=Đường%20Triều",
    "/rest-api/v130/search?api_key={$api_key}&q=Tang%20Dynasty",
    
    // Alternative endpoints
    "/rest-api/v100/search?api_key={$api_key}&q=strange",
    "/rest-api/v100/search?api_key={$api_key}&q=duong%20trieu",
];
