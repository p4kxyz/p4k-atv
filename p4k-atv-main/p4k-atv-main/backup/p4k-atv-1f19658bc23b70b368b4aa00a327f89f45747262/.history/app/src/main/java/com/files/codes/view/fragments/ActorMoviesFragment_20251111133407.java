...
public class ActorMoviesFragment extends VerticalGridSupportFragment {
    ...
    private String instanceId = "Instance_" + System.currentTimeMillis();
    ...
    private void setupUIElements() {
        ...
        // Create unique presenter instance to avoid conflicts
        VerticalCardPresenter cardPresenter = new VerticalCardPresenter(MoviesFragment.MOVIE);
