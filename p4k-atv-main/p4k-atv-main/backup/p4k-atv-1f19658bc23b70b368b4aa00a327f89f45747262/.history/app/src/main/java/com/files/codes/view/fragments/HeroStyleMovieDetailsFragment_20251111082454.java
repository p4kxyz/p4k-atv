...
public class HeroStyleMovieDetailsFragment extends Fragment {
    ...
    private void loadMovieDetails() {
        ...
        // Check if it's TV series or movie
        if ("tvseries".equals(videoType) || "tv".equals(videoType)) {
            call = apiService.getTvSeriesDetails(videoId);
        } else {
            call = apiService.getMovieDetails(videoId);
        }
        ...
        call.enqueue(new Callback<MovieSingleDetails>() {
            ...
            public void onResponse(Call<MovieSingleDetails> call, Response<MovieSingleDetails> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ToastMsg.toastIconError(getContext(), "Failed to load movie details", R.drawable.ic_error);
                }
            }
            ...
            public void onFailure(Call<MovieSingleDetails> call, Throwable t) {
                ...
                ToastMsg.toastIconError(getContext(), "Network error", R.drawable.ic_error);
            }
        });
    }
    ...
    private void toggleFavorite() {
        ...
        ToastMsg.toastIconSuccess(getActivity(), "Favorite feature clicked!", R.drawable.ic_heart);
    }
