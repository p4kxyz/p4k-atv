...
public class HeroStyleMovieDetailsFragment extends Fragment {
    ...
    private void showCastMovies(String actorName) {
        // Chuyển sang trang danh sách phim của diễn viên
        Fragment actorMoviesFragment = ActorMoviesFragment.newInstance(actorName);
        requireActivity().getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, actorMoviesFragment)
                .addToBackStack(null)
                .commit();
    }
