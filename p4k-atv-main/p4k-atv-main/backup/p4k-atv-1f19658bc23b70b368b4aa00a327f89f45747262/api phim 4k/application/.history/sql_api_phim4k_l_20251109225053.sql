...
CREATE TABLE `videos` (
  ...
  `title_vietnamese` varchar(300) DEFAULT NULL COMMENT 'Tên tiếng Việt có dấu',
  `title_vietnamese_no_accent` varchar(300) DEFAULT NULL COMMENT 'Tên tiếng Việt không dấu',
  `title_original` varchar(300) DEFAULT NULL COMMENT 'Tên gốc (English/Original)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
