...
### Bước 0: Cấu hình thông tin database
**Trước khi bắt đầu, sửa thông tin database trong các file PHP:**

1. Mở file `deploy_step2_update_data.php`
2. Sửa dòng 7-10:
```php
$host = 'localhost';        // Server database
$username = 'your_username'; // Username database  
$password = 'your_password'; // Password database
$database = 'sql_api_phim4k_l'; // Tên database
```

3. Mở file `deploy_step3_test_result.php` 
4. Sửa tương tự dòng 7-10
...
### Bước 4: Test kết quả  
**Kiểm tra parsing:**
1. Truy cập: `http://yoursite.com/deploy_step3_test_result.php`
2. Xem bảng kết quả parsing
3. Kiểm tra thống kê và test search
...
-- Test search
SELECT * FROM videos 
WHERE title_vietnamese_no_accent LIKE '%su hoan doi%' 
   OR title_original LIKE '%spider man%'
LIMIT 10;
```
