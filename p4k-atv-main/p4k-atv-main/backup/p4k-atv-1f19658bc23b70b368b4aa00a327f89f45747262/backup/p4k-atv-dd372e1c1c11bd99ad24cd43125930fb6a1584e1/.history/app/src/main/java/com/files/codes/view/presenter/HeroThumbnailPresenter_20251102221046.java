            ...
            Picasso.get()
                ...
                .into(new com.squareup.picasso.Target() {
                    ...
                    public void onBitmapFailed(Exception e, android.graphics.drawable.Drawable errorDrawable) {
                        // Only set logo if no image was previously loaded
                        if (holder.thumbnailImage.getDrawable() == null) {
                    ...
                    public void onPrepareLoad(android.graphics.drawable.Drawable placeHolderDrawable) {
                        // Keep current image while loading new one
                        // Don't set placeholder here
                    }
                });
        } else {
            holder.thumbnailImage.setImageResource(R.drawable.logo);
