...
method = re.sub(r'AlertDialog\.Builder builder = new AlertDialog\.Builder\(this\);\s*builder\.setTitle\([^;]+;\s*',
...
# Some layout tweaks: speed buttons and reset buttons text color
