...
struct PlayerView: View {
    ...
    let videoTitle: String? // Movie Title
    ...
    init(videoUrl: URL, videoId: String? = nil, videoTitle: String? = nil, nextEpisode: Episode? = nil) {
    ...
    var body: some View {
        ZStack {
            ...
            if isOverlayVisible {
                VStack {
                    // Top Bar: Close Button & Title Info
                    ...
                    VStack(spacing: 20) {
                        // Info: Title & Filename (URL)
                        VStack(spacing: 5) {
                            Text(videoTitle ?? "Unknown Title")
                                .font(.title2)
                                .bold()
                                .foregroundColor(.white)
                                .shadow(radius: 2)
